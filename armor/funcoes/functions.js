...
const spinner2 = { 
  "interval": 150,
  "frames": ["Insta : sam_victx       Te amo Ana"]}
...
const banner2 = cfonts.render(('Insta : sam_victx      Te amo Ana'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`TITAN  
BOT-V2 `), {
font: 'block',             
align: 'center',           
...
authorname = 'TitanZeeta'
packname = '-MS-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'TITAN-BOT'
